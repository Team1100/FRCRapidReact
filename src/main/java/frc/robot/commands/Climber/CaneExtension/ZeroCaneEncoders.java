...
public class ZeroCaneEncoders extends CommandBase {
  ...
  public ZeroCaneEncoders(double caneSpeed, boolean parameterized) {
  ...
  public static void registerWithTestingDashboard() {
    ...
    ZeroCaneEncoders cmd = new ZeroCaneEncoders(Climber.INITIAL_CANE_EXTENTION_SPEED, false);
  ...
  public void execute() {
    ...
    m_climber.extendCane(-Math.abs(m_caneSpeed));
  }
