...
import frc.robot.commands.UserControlLights;
...
public class OI {
  ...
  public OI() {
    ...
    if (Constants.XBOX_CONTROLLER_OPERATOR_ENABLE) {
      OperatorXboxController.getDPad().getRight().whenPressed(new UserControlLights(Constants.LIGHTS_OFF));
      OperatorXboxController.getDPad().getDown().whenPressed(new UserControlLights(Constants.LIGHTS_RED));
      OperatorXboxController.getDPad().getUp().whenPressed(new UserControlLights(Constants.LIGHTS_BLUE));
      OperatorXboxController.getDPad().getLeft().whenPressed(new UserControlLights(Constants.LIGHTS_PURPLE));
